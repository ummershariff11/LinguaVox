...
# C:\Users\Sahista\PycharmProjects\Lingua_Virtual\venv\templates
# C:\Users\Sahista\PycharmProjects\Lingua_Virtual\venv\Application.py
@app.route('/')
@app.route('/templates')
def home():
    var_1 = "https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,700,700i|Raleway:300,400,500,700,800|Montserrat:300,400,700"
    var_2 = "https://g.page/cestar-college?share"
    return render_template('/index.html', var_1=var_1, var_2=var_2)
...
@app.route('/video_feed')
def video_feed():
    p = "dist/SignToText.zip"
    return send_file(p, as_attachment=True)

@app.route('/text')
def text():
    q_ = "dist/TextToSign.zip"
    return send_file(q_, as_attachment=True)


# @app.route('/text')
# def text():
#     text_to_sign.application_ts().root.mainloop()
#     return redirect(url_for('home'))
